...
echo "docker run -p 8806:8806 mirecekd/bakalari-mcp:http --user YOUR_USERNAME --password YOUR_PASSWORD --url https://your-school.bakalari.cz"
echo ""
echo "Or with environment variables:"
echo "docker run -p 8806:8806 -e BAKALARI_USER=username -e BAKALARI_PASSWORD=password -e BAKALARI_URL=https://school.bakalari.cz mirecekd/bakalari-mcp:http"
