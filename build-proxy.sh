...
echo ""
echo "Usage:"
echo "  docker run -e BAKALARI_USER=YOUR_USER -e BAKALARI_PASSWORD=YOUR_PASSWORD -e BAKALARI_URL=https://YOUR_SCHOOL.bakalari.cz -p 8805:8805 mirecekd/bakalari-mcp:proxy"
echo ""
